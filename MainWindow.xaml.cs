...
namespace wpf_devourers
{
    public partial class MainWindow : Window
    {
        ...
        private void ChangeElementStance(object sender, RoutedEventArgs e)
        {
            ...
            if (!_lock && (currentWeight == 0 || pucks[player][currentWeight - 1] > 0) && currentWeight > states[coords[0]][coords[1]] && ((SolidColorBrush)gameMatrix[coords[0]][coords[1]].Background).Color != ((SolidColorBrush)Colors[player][0]).Color)
            {
